...
set my_verilog_files [list common/swrvr_dlib.v common/synchronizer_asr.v common/cluster_header.v pr_macro/mul64.v common/test_stub_scan.v srams/bw_r_rf16x160.v rtl/fpu.v]

#/* Top-level Module                               */
set my_toplevel fpu.v

#/* The name of the clock pin. If no clock-pin     */
#/* exists, pick anything                          */
set my_clock_pin gclk
